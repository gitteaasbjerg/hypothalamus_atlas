...
drop_sample_idx_path <- "~/Desktop/9th_semester/RNA-seq/hypothalamus_atlas/Outputs/drop_sample_idx.yaml"
output_path <- "~/Desktop/9th_semester/RNA-seq/hypothalamus_atlas/Outputs/batch_corrected_expression.csv"
